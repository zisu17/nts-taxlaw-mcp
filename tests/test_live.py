...
from nts_taxlaw_mcp.action_client import close_client
from nts_taxlaw_mcp.codes import DECISION_RESULT, DOC_CLASS, ISSUING_AGENCY, TAX_TYPE
from nts_taxlaw_mcp.domains.documents import (
    DECISION_CLASSES,
    INTERPRETATION_CLASSES,
    search_documents,
)
from nts_taxlaw_mcp.query import SORT
...
async def test_mixing_collections_is_rejected() -> None:
    ...
    from nts_taxlaw_mcp.errors import ErrorCode, NtsError
...
async def test_code_tables_still_match_upstream() -> None:
    ...
    from nts_taxlaw_mcp.action_client import call_action
