...
from nts_taxlaw_mcp.html_text import html_to_text, parse_body_html, truncate
...
def test_search_rows_map_to_summary(fixture, name, _c, _l) -> None:
    from nts_taxlaw_mcp.domains.documents import _row_to_summary
...
def test_partial_number_search_returns_multiple_unrelated_docs(fixture) -> None:
    ...
    """
    from nts_taxlaw_mcp.doc_number import is_same_doc_number
